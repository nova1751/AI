...
def datingClassTest():
    ...
    # 从文件中加载数据
    datingDataMat, datingLabels = file2matrix('../Resources/datingTestSet2.txt')  # load data setfrom file
    # 归一化数据
...
def handwritingClassTest():
    # 1. 导入数据
    hwLabels = []
    trainingFileList = listdir('../Resources/trainingDigits')  # load the training set
    ...
    # 2. 导入测试数据
    testFileList = listdir('../Resources/testDigits')  # iterate through the test set
    errorCount = 0.0
